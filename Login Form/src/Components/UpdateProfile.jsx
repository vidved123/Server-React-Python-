    ...
    return (
        <div className="update-profile-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    Mobile Number:
                    <input type="text" name="mobile_number" value={user.mobile_number} onChange={handleChange} required />
                </label>
                <label>
                    Country Code:
                    <input type="text" name="country_code" value={user.country_code} onChange={handleChange} required />
                </label>
                <label>
                    Email:
