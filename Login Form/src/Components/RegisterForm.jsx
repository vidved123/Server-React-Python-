...
export function RegisterForm() {
    ...
    const normalizeCountryCode = (code) => {
        ...
        if (COUNTRY_CODE_MAPPING[code]) return COUNTRY_CODE_MAPPING[code][0];
        return code;
    };
    ...
    const handleSubmit = async (e) => {
        ...
        const normalizedCountryCode = normalizeCountryCode(formData.country_code);
        ...
        try {
            await axios.post("http://127.0.0.1:8080/register", submissionData, {
    ...
    return (
        <div className="form-container">
            ...
            <p className="switch-link full-width">
